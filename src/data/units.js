export const UNITS_DATA = {
  'house-verb-have': {
    ...
    theoryBlock: {
      affirmative: { title: "Affirmative", content: ["I / You / We / They → <span class='text-emerald-100 italic'>have</span>", "He / She / It → <span class='text-orange-200 underline'>has</span>"] },
      negative: { title: "Negative", content: ["I / You / We / They → <span class='text-red-100 italic'>don't have</span>", "He / She / It → <span class='text-orange-200 underline'>doesn't have</span>"] },
      question: { title: "Questions", content: ["<span class='text-blue-100 underline'>Do</span> I/you... <span class='text-blue-100 font-black'>have</span>?", "<span class='text-orange-200 underline'>Does</span> he/she... <span class='text-orange-200 font-black italic'>have</span>?"] },
      shortAnswer: { title: "Short Answers", content: ["Yes, I <span class='font-black'>do</span>. / No, I <span class='font-black'>don't</span>.", "Yes, she <span class='text-orange-200 font-black'>does</span>. / No, she <span class='text-orange-200 font-black'>doesn't</span>."] }
    },
    vocabulary: [
