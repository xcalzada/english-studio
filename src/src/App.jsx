        ...
        <div className="max-w-7xl mx-auto w-full px-4 pt-8 pb-24">
          <ErrorBoundary>
            <Suspense fallback={<ToolLoader />}>
              {/* FIX: key combines unitId+tab — forces fresh mount when either changes,
                  preventing stale exercise state bleeding between units */}
              <ContentComponent key={`${activeUnitId}:${activeTab}`} data={currentUnit} />
            </Suspense>
          </ErrorBoundary>
        </div>
      </div>
