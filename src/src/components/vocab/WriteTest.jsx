...
import { ArrowRight, CheckCircle, XCircle, RotateCcw, Trophy, Flame } from 'lucide-react';
        ...
        {status === 'idle' ? (
          <div className="w-full relative">
            <input ref={inputRef} value={input} onChange={e => setInput(e.target.value)}
              ...
              placeholder="Type in English…" autoComplete="off" aria-label="English translation"
