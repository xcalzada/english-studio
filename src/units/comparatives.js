...
const quiz = [
  ...
  { id:'q01', type:'choice',
    ...
    ans:'older',
    hint:'old = 1 sílaba → regla: añade -er al final.',
  ...
  { id:'q02', type:'choice',
    ...
    ans:'than',
    hint:'Después de cualquier comparativo (older, bigger, faster…) siempre va esta palabra.',
  ...
  { id:'q03', type:'choice',
    ...
    ans:'oldest',
    hint:'old = 1 sílaba → superlativo: añade -est. (Recuerda: "the" lo pone el alumno.)',
  ...
  { id:'q04', type:'choice',
    ...
    ans:'better',
    hint:'good es irregular. No sigue ninguna regla — hay que memorizarlo.',
  ...
  { id:'q05', type:'choice',
    ...
    ans:'more expensive',
    hint:'expensive = 3 sílabas (ex-pen-sive) → regla: "more" delante, el adjetivo no cambia.',
  ...
  { id:'q06', type:'choice',
    ...
    ans:'worse',
    hint:'bad es irregular. No sigue ninguna regla — hay que memorizarlo.',
  ...
  { id:'q07', type:'choice',
    ...
    ans:'happier',
    hint:'happy termina en -y → cambia la y por i y añade -er.',
  ...
  { id:'q09', type:'choice',
    ...
    ans:'a bit',
    hint:'"a bit" = diferencia pequeña. "much" = diferencia grande. "very" NUNCA va con comparativos.',
  ...
  { id:'q14', type:'fill',
    ...
    ans:'than',
    hint:'Después de cualquier comparativo (bigger, older, more expensive…) siempre viene esta palabra.',
  ...
  { id:'q15', type:'fill',
    ...
    ans:'more',
    hint:'interesting = 4 sílabas → usa "more" delante. El adjetivo no cambia.',
  ...
  { id:'q16', type:'fill',
    ...
    ans:'the',
    hint:'Superlativo → SIEMPRE lleva "the" delante. Escríbelo tú.',
  ...
  { id:'q17', type:'fill',
    ...
    ans:'heavier',
    hint:'heavy termina en -y → cambia la y por i y añade -er: heav + ier.',
  ...
  { id:'q19', type:'fill',
    ...
    ans:'easier',
    hint:'easy termina en -y → cambia la y por i y añade -er.',
  ...
  { id:'q20', type:'fill',
    ...
    ans:'older',
    hint:'old = 1 sílaba → añade -er. Comparamos DOS personas.',
  ...
  { id:'q22', type:'fill',
    ...
    ans:'than',
    hint:'"less than" = menos de. Mismo patrón que "more than".',
  ...
  { id:'q23', type:'fill',
    ...
    ans:'bigger',
    hint:'big = 1 sílaba, CVC (b-i-g) → dobla la g antes de -er: bigg + er.',
  ...
  { id:'q24', type:'fill',
    ...
    ans:'more',
    hint:'expensive = 3 sílabas → usa "more". Comparamos DOS hoteles → comparativo.',
  ...
  { id:'q25', type:'fill',
    ...
    ans:'better',
    hint:'good es irregular → ??? Comparamos dos personas.',
  ...
  { id:'q26', type:'fill',
    ...
    ans:'than',
    hint:'Después del comparativo "taller" → "than" + pronombre objeto (him, her, me, us, them).',
  ...
  { id:'q28', type:'fill',
    ...
    ans:'much',
    hint:'¿Grande o pequeña la diferencia? 46 años → "much" (grande) o "a bit" (pequeña).',
  ...
  { id:'q29', type:'fill',
    ...
    ans:'the',
    hint:'Superlativo sin sustantivo → sigue necesitando "the". Escríbelo tú.',
  ...
  { id:'q31', type:'fill',
    ...
    ans:'older',
    hint:'old = 1 sílaba → añade -er. Diferencia pequeña → "a bit".',
  ...
  { id:'q32', type:'fill',
    ...
    ans:'much',
    hint:'¿Grande o pequeña la mejora? De "terrible" a "OK" es un cambio grande.',
  ...
  { id:'q33', type:'error',
    ...
    hint:'tall = 1 sílaba. Palabras cortas usan -est, NUNCA "most".',
  ...
  { id:'q34', type:'error',
    ...
    hint:'Después de un comparativo siempre va "than", nunca "that".',
  ...
  { id:'q35', type:'error',
    ...
    hint:'strong = 1 sílaba → usa -er, NUNCA "more".',
  ...
  { id:'q36', type:'error',
    ...
    hint:'"taller" ya es comparativo. No puedes añadir "more" antes de una forma -er.',
  ...
  { id:'q37', type:'error',
    ...
    hint:'"the more" no existe. Superlativo de palabras largas → "the most".',
  ...
  { id:'q38', type:'error',
    ...
    hint:'"longest" ya es superlativo. No puedes añadir "most" antes de una forma -est.',
  ...
  { id:'q39', type:'order',
    ...
    hint:'Estructura: sujeto + verbo + comparativo + than + segundo elemento.',
  ...
  { id:'q40', type:'order',
    ...
    hint:'"much" va ANTES del comparativo, no después.',
  ...
  { id:'q41', type:'order',
    ...
    hint:'Superlativo: the + adjetivo-est + sustantivo + in + lugar.',
  ...
  { id:'q42', type:'order',
    ...
    hint:'Estructura: the + superlativo + sustantivo + I\'ve ever + participio.',
  ...
  { id:'q43', type:'order',
    ...
    hint:'"much" (diferencia grande) + comparativo + than.',
  ...
  { id:'q44', type:'order',
    ...
    hint:'Superlativo: the + adjetivo-est + sustantivo + in + grupo.',
  ...
  { id:'q45', type:'translate',
    ...
    ans:'Athens is older than Rome.',
    hint:'antiguo → old (1 sílaba) → comparativo + than.',
  ...
  { id:'q46', type:'translate',
    ...
    ans:"It's the worst film I've ever seen.",
    hint:'la peor → the ??? (irregular de bad) · nunca → ever.',
  ...
  { id:'q47', type:'translate',
    ...
    ans:'Canada is much bigger than France.',
    hint:'grande → big (CVC: b-i-g) → dobla la g · mucho más → much + comparativo.',
  ...
  { id:'q48', type:'translate',
    ...
    ans:'What is the longest river in the world?',
    hint:'el más largo → the ??? · long = 1 sílaba → superlativo: -est · del mundo → in the world.',
  ...
  { id:'q49', type:'translate',
    ...
    hint:'un poco → a bit · más caro → more ??? (expensive, 3 sílabas) · de lo que → than.',
  ...
  { id:'q50', type:'translate',
    ...
    ans:'Jupiter is the largest planet in the solar system and it is much larger than the Earth.',
    hint:'el más grande → the ??? · large = 1 sílaba (-e final) → -st · mucho más → much + comparativo.',
